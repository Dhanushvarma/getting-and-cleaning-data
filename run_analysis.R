...
# Author : Penmetsa Dhanush Kumar Varma
...
# Reading the train sets here
subject_train <- read.table("./UCI HAR Dataset/train/subject_train.txt", col.names = "subject")
x_train <- read.table("./UCI HAR Dataset/train/X_train.txt", col.names = features$functions)
y_train <- read.table("./UCI HAR Dataset/train/y_train.txt", col.names = "code")

# Reading the test sets here
...
# Using a descriptive activity names to name the respective activities in the data set
...
# Appropriately the labeling the data sets with descriptive variable names
